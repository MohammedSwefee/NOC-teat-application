...
class vdiBag extends StatelessWidget  implements HasLayoutGroup{
  vdiBag({Key key, this.layoutGroup, this.onLayoutToggle}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: AppBar(title: Text("VDI Baghdad")),
