...
class vdiBas extends StatelessWidget  implements HasLayoutGroup{
  vdiBas({Key key, this.layoutGroup, this.onLayoutToggle}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(title: Text("VDI Basra")),
